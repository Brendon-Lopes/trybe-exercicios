...
console.log(`Losango com diagonais de 32cm e 18cm: ${Exercise.diamond(32, 18)}cm²`);
console.log(`Trapézio com altura 50cm, B 100cm e b 70cm: ${Exercise.trapezoid(50, 100, 70)}cm²`);
